...
+ (UIColor *)blueColor {
  ...
  if (!blueColor) {
    blueColor = [[UIColor alloc] initWithRed:(float)(2 / 255.0)
                                       green:(float)(116 / 255.0)
                                        blue:(float)(210 / 255.0)
                                       alpha:1];
  }
...
+ (UIColor *)lightBlueColor {
  ...
  if (!lightBlueColor) {
    lightBlueColor = [[UIColor alloc] initWithRed:(float)(30 / 255.0)
                                            green:(float)(132 / 255.0)
                                             blue:(float)(217 / 255.0)
                                            alpha:1];
  }
...
+ (UIColor *)whiteBlueColor {
  ...
  if (!whiteBlueColor) {
    whiteBlueColor = [[UIColor alloc] initWithRed:(float)(214 / 255.0)
                                            green:(float)(233 / 255.0)
                                             blue:(float)(248 / 255.0)
                                            alpha:1];
  }
...
+ (UIColor *)greyColor {
  ...
  if (!greyColor) {
    greyColor = [[UIColor alloc] initWithRed:(float)(153 / 255.0)
                                       green:(float)(153 / 255.0)
                                        blue:(float)(153 / 255.0)
                                       alpha:1];
  }
...
+ (UIColor *)lightGreyColor {
  ...
  if (!lightGreyColor) {
    lightGreyColor = [[UIColor alloc] initWithRed:(float)(241 / 255.0)
                                            green:(float)(241 / 255.0)
                                             blue:(float)(241 / 255.0)
                                            alpha:1];
  }
...
+ (UIColor *)blackColor {
  ...
  if (!blackColor) {
    blackColor = [[UIColor alloc] initWithRed:(float)(51 / 255.0)
                                        green:(float)(51 / 255.0)
                                         blue:(float)(51 / 255.0)
                                        alpha:1];
  }
...
+ (UIFont *)fontWithStyle:(NSString *)style {
  ...
  return
      [UIFont fontWithDescriptor:fontDescriptor size:fontDescriptor.pointSize];
}
